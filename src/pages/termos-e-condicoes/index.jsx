    ...
    <>
      ...
      <ResponsiveContainer>
        <div className={styles.termsOfService}>
          <h2>1. Termos</h2>
          <p>
            Ao acessar ao site <a href="/">seu site</a>, você concorda em
          ...
          <p>
            ...
            materiais (informações ou software) no site, apenas para
          ...
          <ol>
            <li>
              Os materiais no site são fornecidos "como estão". O site não
          ...
          <p>
            ...
            ou lucro ou devido à interrupção dos negócios) decorrentes do uso ou
            da incapacidade de usar os materiais, mesmo que o site ou um
            ...
            consequenciais ou incidentais, portanto, essas limitações podem não
            se aplicar a você.
          </p>
          ...
          <p>
            ...
            tipográficos ou fotográficos. O site não garante que qualquer
            material em seu site seja preciso, completo ou atual. O site pode
            fazer alterações nos materiais contidos em seu site a qualquer
            momento, sem aviso prévio. No entanto, o site não se compromete a
