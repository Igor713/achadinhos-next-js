  ...
  return (
    <>
      <div className={styles.termsOfService}>
        <h2>1. Termos</h2>
        <p>
          Ao acessar ao site <a href="/">seu site</a>, você concorda em cumprir
        ...
        <p>
          ...
          licença, não uma transferência de título e, sob esta licença, você não
          pode:
        </p>
        <ol>
        ...
        <p>
          ...
          dessas restrições e poderá ser rescindida a qualquer momento. Ao
        ...
        <ol>
          <li>
            Os materiais no site são fornecidos "como estão". O site não oferece
          ...
          <li>
            Além disso, o site não garante ou faz qualquer representação
        ...
        <h2>4. Limitações</h2>
        <p>
          Em nenhum caso o site ou seus fornecedores serão responsáveis por
          ...
          incapacidade de usar os materiais, mesmo que o site ou um
          representante autorizado tenha sido notificado da possibilidade de
          tais danos. Algumas jurisdições não permitem limitações em garantias
          implícitas ou limitações de responsabilidade por danos consequenciais
          ou incidentais, portanto, essas limitações podem não se aplicar a
          você.
        </p>
        ...
        <p>
          ...
          tipográficos ou fotográficos. O site não garante que qualquer material
          em seu site seja preciso, completo ou atual. O site pode fazer
          alterações nos materiais contidos em seu site a qualquer momento, sem
          aviso prévio. No entanto, o site não se compromete a atualizar os
          materiais.
        </p>

        <h2>6. Links</h2>
        <p>
          O site não analisou todos os sites vinculados ao seu site e não é
          responsável pelo conteúdo de nenhum site vinculado. A inclusão de
          qualquer link não implica endosso pelo site. O uso de qualquer site
          vinculado é por conta e risco do usuário.
        </p>

        <h3>Modificações</h3>
        <p>
          O site pode revisar estes termos de serviço a qualquer momento, sem
        ...
        <p>
          ...
          leis aplicáveis e você se submete irrevogavelmente à jurisdição
          exclusiva dos tribunais naquela jurisdição.
        </p>
      </div>
    </>
  );
