  ...
  return (
    <>
      <div className={styles.privacyPolicy}>
        ...
        <p>
          A sua privacidade é importante para nós. É política do respeitar a sua
          privacidade em relação a qualquer informação sua que possamos coletar
          no site <a href="/">seu site</a>, e outros sites que possuímos e
          operamos.
        </p>
        <p>
        ...
        <p>
          ...
          informação que o oferece no site e com caráter enunciativo, mas não
          limitativo:
        </p>
        <ul>
          <li>
          ...
          <li>
            ...
            (softwares) do site, de seus fornecedores ou terceiros, para
        ...
        <p>Esta política é efetiva a partir de 11 October 2024 14:30</p>
      </div>
    </>
  );
}
